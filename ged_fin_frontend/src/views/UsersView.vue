...
<main class="main-content">
    ...
    <table v-else class="table">
        ...
        <tr v-if="users.length === 0">
            <td colspan="7" style="text-align:center; color:#999">Aucun utilisateur trouvé</td>
        </tr>
...
loadUsers()
alert(showEditModal.value ? 'Utilisateur modifié !' : 'Utilisateur créé !')
...
onMounted(() => { loadUsers(); loadRolesList() })
</script>
