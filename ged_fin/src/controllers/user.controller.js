...
const { 
    ...
    department, isActive, password,
    serviceId, isDirecteur  
} = req.body
...
if (roleId) {
    ...
    if (role.name !== 'MANAGER') updateData.isDirecteur = false
}
...
const updated = await User.findByPk(req.params.id, {
    ...
    { model: Service, as: 'service', attributes: ['id', 'nom', 'code'] }
    ]
})
