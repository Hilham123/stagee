...
router.get('/:id/verify',                   authenticate, isEmployee,   signatureController.verifySignature);
...
router.get('/document/:documentId',         authenticate, isEmployee,   signatureController.getDocumentSignatures);
